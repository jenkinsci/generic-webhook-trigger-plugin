...
class WhitelistVerifierTest {
    ...
    void testThatHostCanBeVerifiedAndInvalidAndValidByAnotherItem() {
        ...
        assertThat(testDoVerifyWhitelist("192.168.0.0", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("192.168.0.1", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("192.168.0.2", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("192.168.0.3", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("192.168.0.4", headers, postContent, whitelist))
                .isFalse();
    }
    ...
    void testThatHostCanBeVerifiedWithSupportedNotations() {
        ...
        final WhitelistItem whitelistItem4 = new WhitelistItem("2001:0db8:85a3:0000:0000:8a2e:0370:7334");
        whitelistItem4.setHmacEnabled(false);

        final WhitelistItem whitelistItem5 = new WhitelistItem("2002:0db8:85a3:0000:0000:8a2e:0370:7334/127");
        ...
        final Whitelist whitelist = new Whitelist(
                enabled, Arrays.asList(whitelistItem1, whitelistItem2, whitelistItem3, whitelistItem4, whitelistItem5));

        assertThat(testDoVerifyWhitelist("1.2.3.4", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("3.2.1.0", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("3.2.1.1", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("3.2.1.10", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("3.2.1.11", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("1.1.1.2", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("2.2.3.50", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("2001:0db8:85a3:0000:0000:8a2e:0370:7334", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("2002:0db8:85a3:0000:0000:8a2e:0370:7335", headers, postContent, whitelist))
                .isTrue();
    }
    ...
    void testThatHostCanBeVerifiedWithCidr() {
        ...
        assertThat(testDoVerifyWhitelist("2.2.2.255", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("2.2.3.0", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("2.2.3.255", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("2.2.4.0", headers, postContent, whitelist))
                .isFalse();
    }
    ...
    void testThatHostCanBeVerifiedWithRanges() {
        ...
        assertThat(testDoVerifyWhitelist("3.2.3.4", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("3.2.3.5", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("3.2.3.10", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("3.2.3.11", headers, postContent, whitelist))
                .isFalse();
    }
    ...
    void testThatHostCanBeVerifiedWithStaticIp() {
        ...
        assertThat(testDoVerifyWhitelist("4.2.3.4", headers, postContent, whitelist))
                .isFalse();
        assertThat(testDoVerifyWhitelist("4.2.3.5", headers, postContent, whitelist))
                .isTrue();
        assertThat(testDoVerifyWhitelist("4.2.3.6", headers, postContent, whitelist))
                .isFalse();
    }
