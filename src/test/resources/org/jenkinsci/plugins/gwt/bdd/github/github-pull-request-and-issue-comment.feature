Feature: It should be possible to get pull request id from both pull_request and issue_comment.

  Scenario: Get pull request id.
    ...
    Given filter is configured with expression: ^(created|opened|reopened|synchronize)$
