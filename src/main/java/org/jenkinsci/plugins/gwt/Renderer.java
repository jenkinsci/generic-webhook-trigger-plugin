...
public class Renderer {
    ...
    @VisibleForTesting
    public static boolean isMatching(final String renderedRegexpFilterText, final String regexpFilterExpression) {
    ...
    @VisibleForTesting
    public static String renderText(String regexpFilterText, final Map<String, String> resolvedVariables) {
    ...
    private static String replaceKey(String regexpFilterText, final String resolvedVariable, final String key) {
        try {
